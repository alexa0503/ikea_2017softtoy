...
function goUploadStep2(){
	$('.upLoadImg').css({'width':'0px','height':'0px','padding-top':'0px','padding-left':'0px'});
	$('.uploadImgBlock').show();
	...
	setTimeout(function(){
		...
		if(imgBili>bili){//横版
			$('.upLoadImg').css({'width':'380px','height':'auto','padding-top':(253-(380/originalImgWidth*originalImgHeight))/2+'px'});
			}
			else{//竖版
				$('.upLoadImg').css({'width':'auto','height':'253px','padding-left':(380-(253/originalImgHeight*originalImgWidth))/2+'px'});
				}
		},100);
	}
